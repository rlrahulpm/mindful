...
public class ProductController {
    ...
    @GetMapping
    @Operation(summary = "Get all products", description = "Get all products for the authenticated user")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<ProductResponse>> getUserProducts(Authentication authentication) {
        ...
        List<Product> products = productRepository.findByUserId(userPrincipal.getId());
        logger.info("Found {} products for user ID: {}", products.size(), userPrincipal.getId());
    ...
    public ResponseEntity<?> getProduct(
        ...
        if (!product.getUser().getId().equals(userPrincipal.getId())) {
            logger.warn("Unauthorized access attempt - User ID: {} tried to access product ID: {} owned by user ID: {}", 
